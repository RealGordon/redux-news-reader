(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  ...
  function CommentForm(_ref) {
    ...
    var handleSubmit = function handleSubmit(e) {
      ...
      dispatch((0, _commentsSlice.postCommentsThunkCreator)({
        comment: comment,
        articleId: articleId
      }));
      setComment('');
  ...
  var Comments = function Comments() {
    ...
    console.log(comments);
    var commentsForArticleId = article && comments ? comments[article.id] : emptyArray; // Dispatch loadCommentsForArticleId with useEffect here.
  
    (0, _react.useEffect)(function () {
      if (article !== undefined) {
        dispatch((0, _commentsSlice.loadCommentsThunkCreator)(article.id));
      }
    }, [article]);
    if (commentsAreLoading === "loading") return /*#__PURE__*/_react["default"].createElement("div", null, "Loading Comments");
  ...
  exports["default"] = exports.createCommentIsPending = exports.isLoadingComments = exports.selectComments = exports.commentsSlice = exports.postCommentsThunkCreator = exports.loadCommentsThunkCreator = void 0;
  ...
  function loadCommentsForArticleId(_x) {
    return _loadCommentsForArticleId.apply(this, arguments);
  } // Create postCommentForArticleId here.(payload creator)
  
  
  function _loadCommentsForArticleId() {
    _loadCommentsForArticleId = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(articleId) {
      var response, json;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
  ...
  function postCommentForArticleId(_x2) {
    return _postCommentForArticleId.apply(this, arguments);
  }
  
  function _postCommentForArticleId() {
    _postCommentForArticleId = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref) {
      var articleId, comment, body, response, json;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              articleId = _ref.articleId, comment = _ref.comment;
              _context2.prev = 1;
              body = JSON.stringify({
                comment: comment
              });
  ...
  var loadCommentsThunkCreator = (0, _toolkit.createAsyncThunk)('comments/loadComments', loadCommentsForArticleId);
  ...
  */
  ...
  exports.loadCommentsThunkCreator = loadCommentsThunkCreator;
  var postCommentsThunkCreator = (0, _toolkit.createAsyncThunk)('comments/postComment', postCommentForArticleId); //an enum to track progress of loading comments
  //progress can be viewed as a state machine with the following stages
  //isLoadingComments: idle||loading||failed||succeeeded
  
  exports.postCommentsThunkCreator = postCommentsThunkCreator;
  var commentsSlice = (0, _toolkit.createSlice)({
    ...
    extraReducers: (_extraReducers = {}, _defineProperty(_extraReducers, loadCommentsThunkCreator.pending, function (state) {
      state.isLoadingComments = 'loading';
    }), _defineProperty(_extraReducers, loadCommentsThunkCreator.fulfilled, function (state, action) {
      state.isLoadingComments = "succeeded";
      state.byArticleId[action.payload.articleId] = action.payload.comments;
    }), _defineProperty(_extraReducers, loadCommentsThunkCreator.rejected, function (state, action) {
      state.isLoadingComments = 'failed';
    }), _defineProperty(_extraReducers, postCommentsThunkCreator.pending, function (state) {
      state.createCommentIsPending = "loading";
    }), _defineProperty(_extraReducers, postCommentsThunkCreator.fulfilled, function (state, action) {
      state.createCommentIsPending = "succeeded";
      state.byArticleId[action.payload.articleId].push(action.payload);
    }), _defineProperty(_extraReducers, postCommentsThunkCreator.rejected, function () {}), _extraReducers)
  });
  ...
  var CurrentArticle = function CurrentArticle() {
    ...
    if (currentArticleIsLoading === "loading") {
  ...
  var handlers = [_msw.rest.get('/api/articles', function (req, res, ctx) {
    ...
    var id = 0;
    id = _comments["default"].reduce(function (a, b) {
    ...
    _comments["default"].push(commentResponse);
